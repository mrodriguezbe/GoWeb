...
import (
	"goweb/clase4/practica2/internal"
	"goweb/clase4/practica2/internal/handler"
	"goweb/clase4/practica2/internal/middleware"
	"goweb/clase4/practica2/internal/repository"
	"goweb/clase4/practica2/internal/service"
	"goweb/clase4/practica2/storage"
	"net/http"
...
func (h *DefaultHTTP) Run() (err error) {
	...
	storage.ReadProducts(&productsMap, "./storage/initial_data.json")
	...
	// - router
	rt := chi.NewRouter()
	rt.Use(middleware.Log, middleware.Auth)
	//   endpoints
